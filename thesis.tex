...
\begin{centeredFigure}[!ht]
	\includegraphics[scale=0.65]{figures/results/plots/summary/pearsonr_pval.pdf}% <------ Don't forget this %
	\caption{P-values of Pearson correlations coefficients in \cref{fig:pearson}}
	\label{fig:pval_pearson}
\end{centeredFigure}

\begin{centeredFigure}[!ht]
	\includegraphics[scale=0.65]{figures/results/plots/summary/spearmanr_pval.pdf}% <------ Don't forget this %
...
\newacronym{roger}{ROGER}{Roche Omnibus of Gene Expression Regulation}
