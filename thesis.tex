...
\todo{What is the most astonishing fact?}
...
\begin{centeredFigure}[!h]
\resizebox{\textwidth}{!}{% <------ Don't forget this %
	\includegraphics{figures/results/plots/summary/pearson.pdf}% <------ Don't forget this %
	}
	\caption{Illustration of WMD distance of two documents}
	\label{fig:pearson}
\end{centeredFigure}

\begin{centeredFigure}[!h]
\resizebox{\textwidth}{!}{% <------ Don't forget this %
	\includegraphics{figures/results/plots/summary/spearman.pdf}% <------ Don't forget this %
	}
	\caption{Illustration of WMD distance of two documents}
	\label{fig:spearman}
\end{centeredFigure}
...
% Use other W2V Models
% Use document space based models instead of word space based once


% We use shortest path PPI as undirected graph, which si might wring
% Shortest path is maybe not robust
...
\resizebox{\textwidth}{!}{% <------ Don't forget this %
	...
	\caption{Execution time per metric and per entire reference data}
	\label{fig:times}
\end{centeredFigure}
